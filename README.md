...
- Documentação centralizada na pasta [docs/](docs/)
...
- [docs/](docs/) (documentação geral)
  - [docs/arquitetura-geral-sistema.md](docs/arquitetura-geral-sistema.md)

## Módulos (Lambdas) e Documentos
- [feedback-ingestion-api](feedback-ingestion-api/) — API HTTP para receber avaliações (Quarkus + AWS Lambda HTTP API)
  - README: [feedback-ingestion-api/README.md](feedback-ingestion-api/README.md)
- [feedback-notification-processor](feedback-notification-processor/) — Processador SQS → DynamoDB → SES, com regra de criticidade (ex.: nota <= 6)
  - README: [feedback-notification-processor/README.md](feedback-notification-processor/README.md)
- [feedback-report-generator](feedback-report-generator/) — Geração de relatórios (PDF), integração com DynamoDB/Storage/E-mail
  - README: [feedback-report-generator/README.md](feedback-report-generator/README.md)
...
- [feedback-ingestion-api](feedback-ingestion-api/)
  - src/main/java/com/fiap/techchallenge/ingestion/... (REST, Service, DTO, Model)
  - [README.md](feedback-ingestion-api/README.md)
- [feedback-notification-processor](feedback-notification-processor/)
  - src/main/java/com/fiap/techchallenge/notification/... (SQS, Service, SES)
  - [README.md](feedback-notification-processor/README.md)
- [feedback-report-generator](feedback-report-generator/)
  - src/main/java/com/fiap/techchallenge/... (domain, application, infrastructure/pdf|dynamo|email|storage)
  - [README.md](feedback-report-generator/README.md)
- [docs](docs/)
  - [arquitetura-geral-sistema.md](docs/arquitetura-geral-sistema.md)
- [.github](.github/)
  - [workflows](.github/workflows/)
    - [deploy.yml](.github/workflows/deploy.yml)
- [template.yaml](template.yaml) (Infra como Código — recursos AWS e integrações)
- [samconfig.toml](samconfig.toml) (configurações de deploy)
